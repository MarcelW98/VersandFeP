...
<!-- Weitere Bearbeitung -->
	...
	<label><strong>Weitere Bearbeitung</strong><span class="text-danger">*</span></label>
      ...
      <option ng-click="insertData()" value="Versandbüro">Versandbüro</option>
      </select>
...
<div class="table-responsive bg-light"> <!--this is used for responsive display in mobile and other devices-->
  <table id="Arbeitsvorrat" class="table table-bordered table-hover table-striped" style="table-layout: fluid">  
      ...
      <?php  
      include("database/db_conection.php");  
      $view_arbeitsvorrat_query="select * FROM versendungen WHERE Status_Verpacken='1' && Status_Klaerung='' && Status_Bereitstellung='' && Status_Storno='' ORDER by Prioritaet_Wareneingang='eilig' DESC, STR_TO_DATE(Datum_Verpacken, '%d.%m.%Y') ASC, Zeit_verpacken ASC";//select query for viewing users.  
