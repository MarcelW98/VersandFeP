<?php
 ...
 class FahrerData {
    ...
    public static function fromAssoc(Array $assoc): FahrerData {
        try {
           return new FahrerData($assoc["id"], $assoc["fahrername"], $assoc["kennzeichen"], $assoc["spedition"], $assoc["bolognr"],  $assoc["Sonderfahrt"],  $assoc["ankunftszeit"], $assoc["abgeschlossen"]);
        } catch (Exception $e) {
