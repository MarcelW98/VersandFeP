...
<div class="form-group center-block text-center col-md-6">
	<label><strong>Dienstleister</strong><span class="text-danger">*</span></label>
      ...
      <option ng-click="insertData()" value="LGI">LGI</option>
...
<div class="table-responsive bg-light"> <!--this is used for responsive display in mobile and other devices-->
  <table id="Arbeitsvorrat" class="table table-bordered table-hover table-striped" style="table-layout: fluid">  
      ...
      <tr>
          ...
          <th>Datum Bereistellung</th>
          <th>Zeit Bereistellung</th>
          <th>Lieferschein</th>
          <th>Weitere Bearbeitung</th>
          <th>Länderhinweis</th>
          <th>Bearbeiter VKS Bereistellung</th>
          <th>Priorität</th>
      ...
      if($buero == 1)
      {
      $view_arbeitsvorrat_query="select * FROM versendungen WHERE Status_Bereitstellung='1' && Weitere_Bearbeitung='Versandbuero' && Status_Transportpapiere='' && Status_Storno='' && Status_Klaerung='' ORDER by Prioritaet_Wareneingang='eilig' DESC, Datum_Bereitstellung ASC, Zeit_Bereitstellung ASC";
      } else 
      if($Werkstatt == 1) {
        $view_arbeitsvorrat_query="select * FROM versendungen WHERE Status_Bereitstellung='1' && Weitere_Bearbeitung='W011927' && Status_Transportpapiere='' && Status_Storno='' && Status_Klaerung='' ORDER by Prioritaet_Wareneingang='eilig' DESC, Datum_Bereitstellung ASC, Zeit_Bereitstellung ASC";    
      } else {    
      $view_arbeitsvorrat_query="select * FROM versendungen WHERE Status_Bereitstellung='1' && Status_Transportpapiere='' && Status_Storno='' && Status_Klaerung='' ORDER by Prioritaet_Wareneingang='eilig' DESC, Datum_Bereitstellung ASC, Zeit_Bereitstellung ASC"; 
      }
