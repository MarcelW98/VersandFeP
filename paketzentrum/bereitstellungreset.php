...
<head lang="en">  
    ...
    <title>Status Bereitstellung zurücksetzen</title>  
</head>   
...
<br /> 
  ...
  <br />
  <h1><p class="bg-danger text-white">Status "bereitstellen" zurücksetzen</h1></p>
  <br />
 </div> 
<br />
<main>
   ...
   <div ng-app="myapp" ng-controller="formcontroller">
    <form id="userForm" name="userForm" ng-submit="insertData()">
     ...
     <div class="form-group col-md-12 center-block text-center">
      ...
      <input type="text" style="text-align:center" id="barcode_scanbereitres" ng-click="reset()" onfocus="" name="barcode_scanbereitres" ng-model="insert.barcode_scanbereitres" tabindex="1" class="form-control inputs" autofocus />
...
<div class="row">
	 ...
	 <button class="btn btn-danger rb-button-sm" onclick="javascript:document.getElementById('barcode_scanbereitres').focus()" ng-click="reset()" type="button">Eingabe zurücksetzen</button>
     </div>    
    </form>
   </div>
  </div>
...
var app = angular.module("myapp", []);
 ...
 $scope.insertData = function(){
  $http({
   method:"POST",
   url:"function/bereitstellenres.php",
   data:$scope.insert,   
...
// Fehlerbehandlung - Barcodescan wenn leer	  
	if(data.error1)
   {
    $scope.errorbarcodescan = data.error1.barcode_scanbereitres;
    document.getElementById('barcode_scanbereitres').focus();
    $scope.insert.barcode_scanbereitres="";
    $scope.successInsert="";
