...
if(!empty($form_data->barcode_scanbereit))
{
    $barcode_scanbereit = mysqli_real_escape_string($dbcon, $form_data->barcode_scanbereit);
...
{
 $barcode_scanbereit= mysqli_real_escape_string($dbcon, $form_data->barcode_scanbereit); 
 $input_Lieferschein = mysqli_real_escape_string($dbcon, $form_data->input_Lieferschein);
 $input_Bearbeitung = mysqli_real_escape_string($dbcon, $form_data->input_Bearbeitung); 
 $input_Lhinweis = mysqli_real_escape_string($dbcon, $form_data->input_Lhinweis); 
 $input_Bereitbearbeiter = "1"; //mysqli_real_escape_string($dbcon, $form_data->input_Bereitbearbeiter);
 $datum = date("d.m.Y");
 $uhrzeit = date("H:i:s");
 $statebereit = "1";
 $stateklaer = "";
