...
if(!empty($form_data->barcode_scanversand))
{
    $barcode_scanversand = mysqli_real_escape_string($connect, $form_data->barcode_scanversand);
...
{
 $barcode_scanversand = mysqli_real_escape_string($connect, $form_data->barcode_scanversand); 
 $input_Versandbearbeiter = mysqli_real_escape_string($connect, $form_data->input_Versandbearbeiter);
 $datum = date("d.m.Y");
 $uhrzeit = date("H:i:s");
 $stateversand = "1";
 $stateklaer = "";
