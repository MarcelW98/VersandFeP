...
<div class="card-deck">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body d-flex flex-column">
		<button class="align-self-end btn rb-button-lg rb-button--primary btn-block" onclick="window.open('https://fe-pt7.de.bosch.com/#/site/PS-FeP/workbooks/6909/views');" role="button">Start</button>
    </div>
  </div>
</div>
</div>
