...
<body class="bg">
    ...
    <div class="bg-danger container-fluid col-md-6 rounded text-center">
        ...
        <br />
        <h1><p class="bg-danger text-white">Klärungsgrund ändern</h1></p>
        <br />
    </div>
    <br />
    <main>
            ...
            <div ng-app="myapp" ng-controller="formcontroller">
                <form id="userForm" name="userForm" ng-submit="insertData()">
                    ...
                    <div class="form-group col-md-12 text-center">
                        <br />
                        <input type="submit" id="insert" name="insert" class="btn rb-button rb-button--primary btn-block" value="Änderung speichern" />
                    </div>
