...
{  
    ...
    if ($_SESSION['user_role'] == 'schichtfuehrer') {
		
             $_SESSION['schichtfuehrer']='schichtfuehrer';
             $_SESSION['last_time'] = time();
             echo "<script>window.open('paketzentrum.php','_self')</script>";
                    
     } else
    
     if ($_SESSION['user_role'] == 'buero') {
		
             $_SESSION['buero']='buero';
             echo "<script>window.open('paketzentrum.php','_self')</script>";
                    
     } else

     if ($_SESSION['user_role'] == 'werkstatt') {
		
         $_SESSION['benutzer']='werkstatt';
         echo "<script>window.open('paketzentrum.php','_self')</script>";
