...
<div class="bg-white container-fluid col-md-6 bg-light rounded text-center">   
  <a><img src="view/media/Logo_groß.png" width="620px" height="120px" class="d-inline-block rounded img-fluid" alt="LOGO"/><h1>Wareneingang erfassen</h1></a>
  <br />
 </div> 
<br />
<main>
...
<!-- Geschäftsbereich -->
	...
	<label><strong>Geschäftsbereich</strong><span class="text-danger">*</span></label>
	  <select type="text" id="input_GB" name="input_GB" ng-model="insert.input_GB" tabindex="3" class="form-control dropdown-toggle">
	  <option value="" selected disabled>Bitte Auswählen</option>
 		<?php
				include("database/db_conection.php"); 
				$sql = 'SELECT * FROM gb';
...
<div class="form-group center-block text-center col-md-6">
	<label><strong>Priorität</strong><span class="text-danger">*</span></label>
	  <select type="text" id="input_Prio" name="input_Prio" ng-model="insert.input_Prio" tabindex="4"  class="form-control">
	  <option value="" selected disabled>Bitte Auswählen</option>
...
<div class="form-group center-block text-center col-md-6">
<!--<input type="text" id="test" class="form-control" name="test" ng-model="insert.test" required>
<span class="bg-danger text-white" ng-show="userForm.test.$touched && userForm.test.$error.required">kjsadhkjsa</span>-->
</div>
<!-- Hinweis -->
<div class="form-group center-block text-center col-md-6">
...
if($Schicht == 1)
{  
    echo "<a href='wareneingangedit.php'><button style='position: absolute; right: 235;'class='btn btn-dark rb-button-sm' type='button'>Wareneingang korrigieren</button></a>";   
} 
...
// Fehlerbehandlung - Auftragsart leer  
   if(data.error2)
   {
    ...
    $scope.errorWareneingbearbeiter = data.error5.input_Wareneingbearbeiter;
    $scope.errorHinweis = data.error6.input_Hinweis;
    $scope.insert.input_Prio="";
    $scope.insert.input_Wareneingbearbeiter="";
    $scope.successInsert="";
...
// Fehlerbehandlung - Prio leer  
   if(data.error4)
   {
    ...
    $scope.errorbarcodescan= "";   
    $scope.errorHinweis = data.error4.input_Prio;
...
if(data.error5)
   {
    if(data.error5.input_Wareneingbearbeiter > "") {
    $scope.errorbarcodescan= "";   
    $scope.errorWareneingbearbeiter = data.error5.input_Wareneingbearbeiter;
...
if(data.error6)
   {
    if(data.error6.input_Hinweis > "") {
    $scope.errorbarcodescan= ""; 
    $scope.errorprio = data.error6.input_Hinweis;
